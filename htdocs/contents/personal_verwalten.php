              ...
              <div class="panel-body">
                <div class="form">
                  ...
                  <form class="form-validate form-horizontal " id="personal_form" method="post" action="">
                    ...
                    <br/>
                    <div class="form-group" >
                      <button id="silButton" class="btn btn-warning" OnClick="onayKutusu('Saallöschen','Wollen Sie diesen Saal wirklich löschen?',personalSil);">Delete</button>
